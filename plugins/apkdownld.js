...
let handler = async (m, { conn, args }) => {
  ...
  await m.reply("⏳ المرجو الانتظار قليلاً، يتم الآن جلب بيانات التطبيق...");
...
handler.command = ['apkdownload', 'تحميل'];
handler.limit = true;
